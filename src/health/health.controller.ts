...
export class HealthController {
    ...
    check() {
        return this.health.check([
            ...
            () => this.diskHealthIndicator.checkStorage("storage", {thresholdPercent: 0.7, path: __dirname}), //el porcentaje del disco no debe exceder del 70%
            () => this.mongoHealthIndicator.pingCheck("mongoDB", {timeout:1500,connection:this.connection}) //verifica la conexion con mongo
        ]);
    }
}
